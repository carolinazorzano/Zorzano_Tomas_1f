...
int menuInformes()
{
    ...
    system("cls") ;
    printf("\n\t\t*** INFORMES ***\n\n");
    printf("1-Listar todos los socios que solicitaron un prestamo\nde un libro determinado(punto C)\n") ;
    printf("2-Listar todos los libros que fueron solicitados a prestamo\npor un socio determinado (punto D)\n") ;
    printf("3-Listar todos los libros solicitados a prestamo en una\nfecha determinada(punto G)\n") ;
    printf("4-Listar todos los socios que realizaron al menos una solicitud\na prestamo en una fecha determinada(punto H)\n") ;
    printf("5-Listar todos los libros ordenados por titulo(descendente),\nutilizando el metodo de burbujeo mas eficiente.(punto I)\n") ;
    printf("6-Listar todos los socios ordenados por apellido(ascendente),\nutilizando el metodo de insercion.(punto J)\n\n") ;
